...
class MlpMixer(nn.Module):
    def __init__(self, num_classes, num_blocks, patch_size, hidden_dim, tokens_mlp_dim, channels_mlp_dim, image_size=64):
...
def mixer_s16(num_classes=1000, **kwargs):
    return MlpMixer(num_classes, 8, 4, 512, 256, 2048, **kwargs)
